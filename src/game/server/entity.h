...
protected:
	...
	int m_ID;
	// Battlefield entities often emit several laser/projectile snapshot objects.
	// Reserve nine extra IDs; the base destructor frees the active prefix.
	int m_aExtraIDs[9];
	int m_NumExtraIDs;
	int m_ObjType;

	void AllocExtraIDs(int NumIDs);
