...
# The recovered server must remain wire-compatible with battle_srv. Its source
# necessarily differs from the lost build inputs, so deriving this identifier
# from the reconstructed implementation would reject the original clients
# after every recovery edit.
